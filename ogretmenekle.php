...
<br><br><br>  >
    ...
    <section class="site-section">
      <div class="container">
        <div class="row" style="margin-right:-263px">
          <div class="col-md-6 col-lg-4" style="margin-left:85px">
              
              <h2 class="text-primary">Sınav not atama</h2>
...
?>
          ...
          <div class="col-md-6 col-lg-4" style="margin-left: 0px;">
              <h2 class="text-primary"></h2>


          </div>

          <div class="col-md-6 col-lg-4" style="margin-left: -400px;">             
             <h2 class="text-primary">Sınav Güncelleme</h2>
